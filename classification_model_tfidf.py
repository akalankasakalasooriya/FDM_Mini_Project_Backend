...
def train_model():
    ...
    # dump
    with open(os.getcwd()+'/datasets/classification_datasets/logistic_clean_movie_data_classif.pickle', 'wb') as f:
        pickle.dump(new_md, f)

    # load
    load = pickle.dump
    with open(os.getcwd()+'/datasets/classification_datasets/logistic_clean_movie_data_classif.pickle', 'rb') as f:
    ...
    with open(os.getcwd()+'/models/classification_models/logistic_reg_ml_binarizer.pickle', 'wb') as f:
        pickle.dump(new_md, f)
    ...
    # dump
    with open(os.getcwd()+'/Classif_PlotSum/logistic_reg_tf_idf_vectorizer.pickle', 'wb') as f:
        pickle.dump(new_md, f)
    ...
    print('saving model...')
    # dump the model
    with open(os.getcwd()+'/models/classification_models/logistic_reg_ovr_classif.pickle', 'wb') as f:
        pickle.dump(new_md, f)
...
def get_predictions(input):
    # load the model
    load = pickle.dump
    with open(os.getcwd()+'/models/classification_models/logistic_reg_ovr_classif.pickle', 'rb') as f:
        logistic_reg_ovr_classif_model = pickle.load(f)

    clean_input = data_preprocess(input)

    # load the tfidf vectorizer
    with open(os.getcwd()+'/models/classification_models/logistic_reg_tf_idf_vectorizer.pickle', 'rb') as f:
    ...
    input_prediction = logistic_reg_ovr_classif_model.predict(input_tfidf)

    with open(os.getcwd()+'/models/classification_models/logistic_reg_ml_binarizer.pickle', 'rb') as f:
