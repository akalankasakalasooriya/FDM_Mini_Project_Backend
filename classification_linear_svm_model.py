...
def train_model():
    ...
    with open(os.getcwd()+'/models/classification_models/lsvm_ml_binarizer.pickle', 'wb') as f:
        pickle.dump(new_md, f)
    ...
    # dump
    with open(os.getcwd()+'/Classif_PlotSum/lsvm_tf_idf_vectorizer.pickle', 'wb') as f:
        pickle.dump(new_md, f)
    ...
    l_svm = LinearSVC(random_state=42)
    clf = OneVsRestClassifier(l_svm)
    ...
    # dump the model
    with open(os.getcwd()+'/models/classification_models/lsvm_ovr_classif.pickle', 'wb') as f:
        pickle.dump(new_md, f)
...
def get_predictions(input):
    # load the model
    load = pickle.dump
    with open(os.getcwd()+'/models/classification_models/lsvm_ovr_classif.pickle', 'rb') as f:
        lsvm_ovr_classif_model = pickle.load(f)

    clean_input = data_preprocess(input)

    # load the tfidf vectorizer
    with open(os.getcwd()+'/models/classification_models/lsvm_tf_idf_vectorizer.pickle', 'rb') as f:
    ...
    with open(os.getcwd()+'/models/classification_models/lsvm_ml_binarizer.pickle', 'rb') as f:
